...
namespace Hangman
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            DisableButtons(); //disable buttons til newGame button clicked
            this.KeyPreview = true; //enable keys
            this.KeyDown += Form1_KeyDown;
            radRandom.Checked = true; //defaults 
            radMedium.Checked = true; //
            btnShowAnswer.Visible = false; //hide this
        }

        public void DisableButtons() //disable buttons and keys
        {
        ...
        private void btnNewGame_Click(object sender, EventArgs e)
        {
            ...
            //create char[] of the display and the 2nd copy
            //(2nd copy will be used for checking for wrong guesses
            ...
            {
                //so basically, it is unreadable if there aren't spaces, so
                //i kinda had to do it this way
                disp[i] = '_';
                disp[i + 1] = ' ';
                oldDisp[i] = '_';
                oldDisp[i + 1] = ' ';
        ...
        //when they lose, disable buttons and show 'show answer' button
        public void Lost()
        {
            DisableButtons();
        ...
        private void btnShowAnswer_Click(object sender, EventArgs e)
        {
            ...
            lblDisplay.Text = answerString;
        }

        //this handles all the keyboard input
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                //only redirct to the click method
                ...
                case Keys.Z:
                    ...
                    break;
                case Keys.RShiftKey: //i dont think this is working
