...
namespace Hangman
{
    public partial class Form1 : Form
    {
        ...
        //string[] veggies = {"artichoke", "arugula", "asparagus", "avocado", "beet", "broccoli", "cabbage", "calabash", "capers", "carrot", "cauliflower", "celery", "celtuce", "chayote", "cucumber", "gherkin", "edamame", "endive", "escarole", "fennel", "fiddlehead", "galangal", "garlic", "ginger", "greens", "dandelion greens", "kale", "rapini", "spinach", "horseradish", "jicama", "kale", "curly", "lacinato", "ornamental", "kohlrabi", "leeks", "lemongrass", "lettuce", "iceberg", "romaine", "napa cabbage", "nopales", "okra", "olive", "onion", "parsley", "parsnip", "peas", "plantain", "potato", "pumpkin", "purslane", "radicchio", "radish", "rutabaga", "shallots", "spinach", "taro", "tomatillo", "tomato", "turnip", "watercress", "yams", "zucchini"};
